...
RSpec.describe Year2025::Day01 do
  ...
  describe "part 1" do
    ...
    it "returns 1139 for my input" do
      expect(described_class.part_1(input)).to eq(1139)
    end
  end
  ...
  describe "part 2" do
    ...
    it "returns 6684 for my input" do
      expect(described_class.part_2(input)).to eq(6684)
    end
  end
end
